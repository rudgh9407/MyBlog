...
function anotherEvent() {
  ...
  const skill_items = $(`.skill_page>section>section>article>article`);
  ...
  const skill_bubbles = $(`.skill_page>section>section>article`);
  const skill_arr = [
    "../img/html5-icon.png",
    "../img/css3-icon.png", 
    "../img/js-icon.png", 
  ...
  skill_tl.to(skill_areas, { transform: 'translateY(0)', delay: 2 })
    ...
    .to(skill_bubbles, { transform: 'scale(1)' })
  ...
  $(skill_items).each(function(i){
    this.addEventListener("mouseenter", function(e){
      ...
      gsap.fromTo(skill_view, 
        ...
        {transform: 'scale(1)', width: '35%',  ease: 'Power4.easeOut', duration: 1}
      )
    });
    this.addEventListener('mouseleave', function(e){
      ...
      gsap.fromTo(skill_view, 
        ...
        {transform: 'scale(0)', width: '0%', ease: 'Power4.easeOut', duration: 1}
      )
    })
  })
